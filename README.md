...
If you would like to build the image from the Dockerfile. * Note you can modify the Dockerfile or app01.py and wsgi.py to customize this to your liking otherwise it will give you the hello world example app.
```
